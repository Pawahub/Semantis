...
export default ({ init }) => {
  ...
  const initSection = (
    <div className="initSection" onClick={startQuiz}>
      <h6 className="mb-4">Что будем делать?</h6>
      <div data-value="/web-dev/"><span className="number">1</span>Создавать сайт</div>
      <div data-value="/seo/"><span className="number">2</span>Оптимизацию сайта</div>
