      ...
      <div className="row justify-content-end">
        <div className="col-lg-7 col-md-8">
          <div className="first-section-IP__content">
            ...
            <p>Сайт есть, но не работает так, как хотелось бы?<br/>Клиенты не могут найти информацию о вас?<br/><b>Сделайте свой бизнес заметнее!</b><br/>
              Мы поможем Вашему бизнесу достичь новых высот благодаря правильному позиционированию в интернете.</p>
