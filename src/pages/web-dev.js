...
const WebDevPage = ({ location }) => {
  ...
  if (typeof window !== `undefined`) {
    ...
    <mains style={{opacity: 0}}>
      ...
      <p>Лендинг (продающая страница) позволяет максимально вовлечь аудиторию в ваш проект и увеличить продажи. Отлично
      ...
      <p>Корпоративный сайт позволяет эффектно презентовать компанию как надёжного партнёра, поднять статус компании и
        повысить лояльность клиентов. Сделает вашу бизнес-идею более понятной и открытой для публики и увеличит ценность
        вашего продукта.
      ...
      <p>Интерент-магазин позволяет многократно увеличить продажи товаров и услуг через интернет, продавая товары 24/7.
        А также снизить затраты на содержание, проводить онлайн рекламные игры и промоакции и привлекать неограниченное
